...
import com.quartzshard.aasb.common.item.equipment.tool.dm.DarkMatterSword;
...
public class ObjectInit {
	...
	public class Items {
		...
		public static final RegistryObject<Item>
			...
			ELIXIR_OF_LIFE = REG.register("elixir_of_life", () -> new Item(ITEM_PROPERTIES_GENERIC)),
			...
			DARK_MATTER_SWORD = REG.register("dark_matter_sword", () -> new DarkMatterSword(AASBToolTier.DARK_MATTER, 3, -1.6f, ITEM_PROPERTIES_DM_GEAR)),
