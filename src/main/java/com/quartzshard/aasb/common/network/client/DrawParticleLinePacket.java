	...
	public boolean handle(Supplier<NetworkEvent.Context> sup) {
		...
		ctx.enqueueWork(() -> {
			...
			case SENTIENT_TRACER: // sentient arrow tracer
				particles.put(new DustParticleOptions(new Vector3f(Color.PHILOSOPHERS.R/255f, Color.PHILOSOPHERS.G/255f, Color.PHILOSOPHERS.B/255f), 1), 0.1);
			...
			default: // invalid
				LogHelper.warn("DrawParticleLinePacket", "InvalidPreset", "Line particles preset " + preset + " is undefined!");
